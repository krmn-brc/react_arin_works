...
function Header() {
    return (
        <div className="title">
            <h1>Team Members</h1>
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quaerat minus quibusdam ipsam nesciunt id necessitatibus maxime consequuntur nisi, ex non, amet velit dignissimos eveniet! Veniam alias iure nisi totam esse?</p>
        </div>
    )
}
